...
def parse_opt(known=False):
    ...
    parser.add_argument('--artifact_alias', type=str, default='E:/Matrice.ai/yolov9-main\models\detect', help='Version of dataset artifact to use')
    parser.add_argument('--config', type=str, help='Path to config YAML file containing all hyperparameters and arguments', required=True)
